...
const botao = document.querySelector(".btn-plataforma"); // O método de criar uma variável CONST 
const elementoPlataformas = document.querySelector(".btn-plataforma .plataformas");
botao.addEventListener("click", () => {
    elementoPlataformas.classList.toggle("ativo"); // O método TOGGLE serve para alternar uma ação.
});